...
FILES_BONUS = main.c hooks.c map.c init.c  \
			...
			raycasting_1.c raycasting_2.c raycasting_3.c portals.c \
			utils_1.c utils_2.c utils_3.c utils_raycasting_1.c utils_raycasting_2.c z_buffer_1.c z_buffer_2.c \
			gnl.c utils_gnl.c
