...
/*   Updated: 2024/07/05 00:35:41 by tgriblin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	raycast_put_pixel(t_game *g, t_cam *c, int x, int y)
{
	...
	if (c->cell_x >= 0 && c->cell_x < g->map->sizes[c->cell_y]
		&& c->cell_y >= 0 && c->cell_y < g->map->height
		&& g->map->content[c->cell_y][c->cell_x] == '0')
	{
